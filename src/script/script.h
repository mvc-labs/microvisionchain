...
#ifndef MVC_SCRIPT_SCRIPT_H
#define MVC_SCRIPT_SCRIPT_H
...
public:
    ...
    mvc::instruction_iterator begin_instructions() const;
    mvc::instruction_iterator end_instructions() const;
    ...
    /**
     * Pre-version-0.6, MVC always counted CHECKMULTISIGs as 20 sigops. With
...
bool IsP2SH(mvc::span<const uint8_t>);
bool IsDSNotification(mvc::span<const uint8_t>);
bool IsDustReturnScript (mvc::span<const uint8_t> script);


size_t CountOp(mvc::span<const uint8_t>, opcodetype);
